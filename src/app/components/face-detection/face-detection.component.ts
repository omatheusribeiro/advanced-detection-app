...
export class MeshDrawerService {
    private TRIANGULATION: number[] = [
        127,
        34,
        139,
        11,
    ...
    public drawMesh(predictions: any[], ctx: CanvasRenderingContext2D): void {
